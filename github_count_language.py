...
for repo in repositories:
    ...
    if repo_language in language_counts:
...
# Programlama dillerinin kullanım sayılarını bir DataFrame'e dönüştürün ve CSV dosyasına kaydedin
language_df = pd.DataFrame(list(language_counts.items()), columns=['Programming Language', 'Count'])
